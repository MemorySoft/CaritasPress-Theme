<?php
/**
*   CONFIGURACIÓN DE DATOS DE LA ORGANIZACIÓN
*   -----------------------------------------
...
add_action('admin_menu', 'caritaspress_crea_menu_organizacion');
add_action('admin_init', 'caritaspress_registra_opciones_organizacion');

function caritaspress_crea_menu_organizacion() {
  add_submenu_page(
  	"configuracion",
  	__("Organización"), 
  	__("Organización"), 
  	"manage_options", 
  	"delegacion", 
  	"caritas_datos_organizacion"
  	);
}

function caritaspress_registra_opciones_organizacion() {

  add_option("organizacion_nombre","","","yes");
  add_option("organizacion_direccion","","","yes");
  add_option("organizacion_telefono","","","yes");
  get_option("organizacion_telefono_icono_visibilidad","","","yes");
  add_option("organizacion_horario_am","","","yes");
  add_option("organizacion_horario_pm","","","yes");
  get_option("organizacion_horario_icono_visibilidad","","","yes");
  ...
  register_setting("opciones_delegacion", "organizacion_telefono_icono_visibilidad");
  register_setting("opciones_delegacion", "organizacion_horario_am");
  register_setting("opciones_delegacion", "organizacion_horario_pm");
  register_setting("opciones_delegacion", "organizacion_horario_icono_visibilidad");
...
function caritas_datos_organizacion() {
      ...
      <form method="post" action="options.php">
        ...
        <table class="form-table">
          <tr valign="top">
            ...
            <p class="description">Nombre de la empresa, entidad, asociación o marca personal</p></td>
          </tr>
          <tr valign="top">
          ...
          <tr valign="top">
            <th scope="row">Mostrar icono del teléfono</th>
            <td>
            <?php $options = get_option( "organizaciontelefono_icono_visibilidad" ); ?>
            <input type="checkbox" name="organizaciontelefono_icono_visibilidad" <?php checked( $options, 1 ); ?> value="1"> <span class="description">Desmarcar para ocultar el icono de telefono</span>
          </tr>
          <tr valign="top">
          ...
          <tr valign="top">
            <th scope="row">Mostrar icono de horario</th>
            <td>
            <?php $options = get_option( "organizacion_horario_icono_visibilidad" ); ?>
            <input type="checkbox" name="organizacion_horario_icono_visibilidad" <?php checked( $options, 1 ); ?> value="1"> <span class="description">Desmarcar para ocultar el icono de horario</span>
          </tr>
          <tr valign="top">
        ...
        <p>Enlaces a los perfiles oficiales en redes sociales de esta organización que aparecen en el footer.</p>
        <table class="form-table">
          <tr valign="top">
